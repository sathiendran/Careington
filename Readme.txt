Plugins to be installed
	1. cordova plugin add https://github.com/EddyVerbruggen/LaunchMyApp-PhoneGap-Plugin.git --variable URL_SCHEME=snapmdconnectedcare
	...
	4. cordova plugin add https://github.com/katzer/cordova-plugin-background-mode.git
	5. cordova plugin add com.ionic.keyboard
	6. cordova plugin add cordova-plugin-splashscreen
	7. cordova plugin add cordova-plugin-inappbrowser
	8. cordova plugin add org.apache.cordova.dialogs
	9. cordova plugin add https://github.com/katzer/cordova-plugin-local-notifications
