                    ...
                    if (!!this.id) {
                      /*  $eventAggregator.published("itemSelector_onProfileClick", {
                       ...
                       var defaultMessage = "Viewing this profile will exit current page. Do you want to proceed?";
                           ...
                           //     'Viewing this profile will exit the scheduler. Do you want to proceed?',
                           //     function(index) {
                           //         if (index === 1) {
                           //
                           //         } else if (index === 2) {
                           //            sessionStorage.setItem("snap_tabName_ref", this.id);
                           //           // location.href = "#/tab/appoimentDetails/webSSAppointUpdate"+ aa1;
                           //            window.location.href = "#/tab/healthinfo/"+this.id;
                           //         }
                           //     },
                           //     'Confirmation:', ['No', 'Yes']
                           // );
