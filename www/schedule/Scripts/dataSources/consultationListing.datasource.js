...
(function ($, global, snap, kendo) {
    "use strict";
    snap.use(["SnapNotification", "snap.common.schedule.ScheduleCommon", "snap.service.availabilityBlockService", "snap.admin.schedule.TimeUtils"]).define("consultationsListingDataSource", function ($snapNotification, $scheduleCommon, $availabilityBlockService, $timeUtils) {
                ...
                transport: {
                    ...
                    parameterMap: function (data, type) {
                        ...
                        if (type !== "read") {
                            ...
                            // data.PatientOrPhysicianNameFilter = filters.patientOrPhysicianNameFilter;
                ...
                transport: {
                    read: function (options) {
                        ...
                        $availabilityBlockService.getUserCurrentTime().done(function (userCurrentTimeResponse) {
                            ...
                            } else if (filter.status === ds.consultationStutuses.Scheduled) {
                                if (startDate < userDNATime) {
