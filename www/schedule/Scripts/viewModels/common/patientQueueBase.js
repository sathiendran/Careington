        ...
        .define("patientQueueBase", function (
            ...
            function Constructor () {
                ...
                this.removeCardFromPatientQueue = function(appointmentId) {
                    ...
                    if(dismissedCard) {
                        this._removePatientCardFromList(dismissedCard);
                ...
                this.vm_onProfileDetailsClose = function(e) {
                    ...
                    if(!this._selectedPatient.isConnected()) {
                        this._removePatientCardFromList(this._selectedPatient);
                    }
                ...
                this._resetCardLockTimerTime = function() {
                    ...
                    $snapWaitingRoomConsultationsHub.renewLock();
                };
                ...
                this._updatePreConsultationMessage = function(meetingId) {
                    ...
                    if(card) {
                        ...
                        if(this.vm_isChatVisible && this._selectedPatient !== null && card.patientQueueEntryId === this._selectedPatient.patientQueueEntryId) {
                ...
                this._restoreSelectedPatientCardState = function() {
                    ...
                    if(selectedPatient) {
                        ...
                        var card = this.selectPatientCard(selectedPatient.patientQueueEntryId, tmp.isEncounterMetadataVisible || tmp.isChatVisible);
                        card.showOptions(selectedPatient.vm_showOptions);
