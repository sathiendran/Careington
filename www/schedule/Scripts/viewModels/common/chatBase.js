...
(function ($, snap, kendo, global) {
    ...
    snap.namespace("snap.common.chat")
        .use(["snapNotification", "snap.EventAggregator", "snap.hub.MeetingHub", "snap.Service.MessengerService", "snap.admin.schedule.TimeUtils", "snap.hub.mainHub"])
        .define("chatBase", function ($snapNotification, $eventAggregator, $meetingHub, $metingService, $timeUtils, $mainHub) {
