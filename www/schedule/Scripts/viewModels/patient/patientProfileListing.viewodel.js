...
(function (global, $, snap, snapPopUp) {
    ...
    var PatientProfile = kendo.data.Model.define({
        ...
        updateAuthorization: function () {
            ...
            var description = '';
            if (that.isAuthorized) {
                title = 'De-Authorize Dependent';
                description = 'You will no longer be able to view profile or perform consultations until you authorize again.';
            } else {
                title = 'Authorize Dependent';
                description = 'By adding this new user to my account, I declare that either he or she is my child or an individual \
