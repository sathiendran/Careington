...
(function(global, $) {
    ...
    snap.namespace("snap.hub")
        .define("hubModel", function() {
            ...
            this.off = function (eventName, eventCb) {
                if (eventName) {
                    var eventCbList = eventList[eventName] || [];
                    if (eventCb) {
                        var index = -1;
                        var cbToRemove = eventCbList.find(function(cb, ind) {
                            if (eventCb.guid === cb.guid) {
                                index = ind;
                                return true;
                            }
                            return false;
                    ...
                    // Calling .off() with no arguments removes all handlers
                    eventList = {};
                }
                return this;
            };
                ...
                if (wasConsultation) {
                  //  snapInfo("Attempting to reconnect...."); //todo keep this up
                    navigator.notification.alert(
                        alertInternetConnection, //'No Internet Connection.', // message
                        function() {
              ...
              //     alert("You have logged in on another device and ended this session.");
                   ...
                   var localizeCurrent = $('#localize-current').text();
                    ...
                    navigator.notification.alert(
                        ...
                        sessAlertMessage,
                         ...
                         snap.appName, // title
                         YESMessageProviderSearch // buttonName
                     );
                     return false;
                 };
                ...
                sessionLimiterHub.client.forceLogout = function(ip) {
                 ...
                 showSnapAlert("You have logged in on another device.", "confirmation");
                    ...
                    var sessAlertMessage = "You have logged in on another device.";
                  var sessAlertDone = 'Done';
                    ...
                    navigator.notification.alert(
                        sessAlertMessage, //'You have logged in on another device.', // message
                        function() {
                            debugger;
